...
function getResultHTML(type) {
    const content = {
        ...
        krysa: {
            ...
            risks: 'Съедает команду изнутри: конфликты, текучка сильных, падение результата, управляемость уходит.',
            advice: 'Стратегия «Прозрачность и ответственность»: факты и фиксация, единые правила поведения, ограничение влияния и доступа к информации, публичные критерии результата. При повторе — расставание.'
        }
    };
